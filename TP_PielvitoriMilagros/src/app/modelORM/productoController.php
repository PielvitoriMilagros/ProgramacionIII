...
class productoController implements IApiControler
{
    ...
    public function CargarUno($request, $response, $args)
    {
        ...
        $productoNuevo->tipo = $arrayDeParametros["tipo"];
    ...
    public function ModificarUno($request, $response, $args)
    {
        ...
        if ($contadorModificaciones > 0 && $contadorModificaciones <= 5 && $id != null && $producto != null) {
            $producto->save();
            $newResponse = $response->withJson('Producto ' . $id . ' modificado', 200);
        } else if ($id == null) {
            $newResponse = $response->withJson('No se introdujo un id valido', 200);
